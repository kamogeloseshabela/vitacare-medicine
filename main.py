...
def get_screen_imports() -> Dict[str, Type[Screen]]:
    ...
    screen_imports = {
        ...
        'doctor_chat': 'DoctorChatScreen',
        'patient_chat': 'PatientChatScreen',
        'doctor_video_call': 'DoctorVideoCallScreen',
        'patient_video_call': 'PatientVideoCallScreen',
        'patient_prescriptions': 'PatientPrescriptionsScreen',
        'patient_consultations': 'PatientConsultationsScreen'
    }
    
    screens = {}
    for screen_name, class_name in screen_imports.items():
        try:
            module = __import__(f'screens.{screen_name}', fromlist=[class_name])
...
def load_kv_files() -> bool:
    ...
    kv_files = [
        ...
        "patient_chat.kv",
        "video_call.kv",
        "doctor_video_call.kv",
        "patient_video_call.kv",
